...
declare module "osu-droid" {
     ...
     * Represents an osu!standard hit object with difficulty calculation values.
     */
    export class RebalanceDifficultyHitObject {
        /**
         * The underlying hitobject.
         */
        readonly object: HitObject;
     ...
     * A converter used to convert normal hitobjects into difficulty hitobjects.
     */
    export class RebalanceDifficultyHitObjectCreator {
        /**
         * The threshold for small circle buff for osu!droid.
         */
        private readonly DROID_CIRCLESIZE_BUFF_THRESHOLD: number;
     ...
     * Represents the skill required to correctly aim at every object in the map with a uniform CircleSize and normalized distances.
     */
    export class RebalanceDroidAim extends RebalanceDroidSkill {
        protected override readonly skillMultiplier: number;
        protected override readonly strainDecayBase: number;
        protected override readonly reducedSectionBaseline: number;
        protected override readonly reducedSectionCount: number;
         ...
         * @param current The hitobject to calculate.
         */
        protected override strainValueAt(current: RebalanceDifficultyHitObject): number;
        /**
         * @param currentObject The hitobject to save to.
         */
        protected override saveToHitObject(current: RebalanceDifficultyHitObject): void;
    }
     ...
     * A performance points calculator that calculates performance points for osu!droid gamemode.
     */
    export class RebalanceDroidPerformanceCalculator extends RebalancePerformanceCalculator {
        override stars: RebalanceDroidStarRating;
        protected override finalMultiplier: number;
        /**
         * The aim performance value.
         */
        ...
        override calculate(params: {
             ...
             * The star rating instance to calculate.
             */
            stars: RebalanceDroidStarRating;
            /**
             * The maximum combo achieved in the score.
             */
            combo?: number;
     ...
     * Represents the skill required to press keys or tap with regards to keeping up with the speed at which objects need to be hit.
     */
    export class RebalanceDroidTap extends RebalanceDroidSkill {
        protected override readonly historyLength: number;
        protected override readonly skillMultiplier: number;
        protected override readonly strainDecayBase: number;
        protected override readonly reducedSectionBaseline: number;
    ...
    export class RebalanceMapStars {
         ...
         * The osu!standard star rating of the beatmap.
         */
        readonly pcStars: RebalanceOsuStarRating;
        /**
         * Calculates the star rating of a beatmap.
         */
        calculate(params: {
     ...
     * Represents the skill required to correctly aim at every object in the map with a uniform CircleSize and normalized distances.
     */
    export class RebalanceOsuAim extends RebalanceOsuSkill {
        protected override readonly skillMultiplier: number;
        protected override readonly strainDecayBase: number;
        protected override readonly reducedSectionCount: number;
        protected override readonly reducedSectionBaseline: number;
     ...
     * Represents the skill required to memorize and hit every object in a beatmap with the Flashlight mod enabled.
     */
    export class RebalanceOsuFlashlight extends RebalanceOsuSkill {
        protected override readonly historyLength: number;
        protected override readonly skillMultiplier: number;
        protected override readonly strainDecayBase: number;
        protected override readonly reducedSectionCount: number;
     ...
     * A performance points calculator that calculates performance points for osu!standard gamemode.
     */
    export class RebalanceOsuPerformanceCalculator extends RebalancePerformanceCalculator {
        override stars: RebalanceOsuStarRating;
        protected override finalMultiplier: number;
        /**
         * The aim performance value.
         */
     ...
     * Represents the skill required to press keys or tap with regards to keeping up with the speed at which objects need to be hit.
     */
    export class RebalanceOsuSpeed extends RebalanceOsuSkill {
        /**
         * Spacing threshold for a single hitobject spacing.
         */
        private readonly SINGLE_SPACING_THRESHOLD: number;
         ...
         * Calculates a rhythm multiplier for the difficulty of the tap associated with historic data of the current object.
         */
        private calculateRhythmBonus(current: RebalanceDifficultyHitObject): number;
        /**
         * @param current The hitobject to save to.
         */
        protected override saveToHitObject(current: RebalanceDifficultyHitObject): void;
     ...
     * and to calculate a final difficulty value representing the difficulty of hitting all the processed objects.
     */
    abstract class RebalanceDroidSkill extends RebalanceStrainSkill {
        /**
         * The bonus multiplier that is given for a sequence of notes of equal difficulty.
         */
        protected abstract readonly starsPerDouble: number;
     ...
     * and to calculate a final difficulty value representing the difficulty of hitting all the processed objects.
     */
    abstract class RebalanceOsuSkill extends RebalanceStrainSkill {
        /**
         * The number of sections with the highest strains, which the peak strain reductions will apply to.
         * This is done in order to decrease their impact on the overall difficulty of the map for this skill.
         */
     ...
     * The base class of performance calculators.
     */
    abstract class RebalancePerformanceCalculator {
        /**
         * The overall performance value.
         */
        total: number;
         ...
         * The calculated beatmap.
         */
        abstract stars: RebalanceStarRating;
        /**
         * The map statistics after applying modifications.
         */
        protected mapStatistics: MapStats;
    ...
    abstract class RebalanceSkill {
         ...
         */
        protected readonly previous: RebalanceDifficultyHitObject[];
        /**
        ...
        processInternal(current: RebalanceDifficultyHitObject): void;
        /**
         * Processes a hitobject.
         *
         * @param current The hitobject to process.
         */
        protected abstract process(current: RebalanceDifficultyHitObject): void;
        /**
     ...
     * and to calculate a final difficulty value representing the difficulty of hitting all the processed objects.
     */
    abstract class RebalanceStrainSkill extends RebalanceSkill {
        /**
         ...
         * @param current The hitobject to process.
         */
        protected override process(current: RebalanceDifficultyHitObject): void;
         ...
         */
        protected abstract strainValueAt(current: RebalanceDifficultyHitObject): number;

        /**
         * Saves the current strain to a hitobject.
         */
        protected abstract saveToHitObject(current: RebalanceDifficultyHitObject): void;
    }

    /**
     * The base of difficulty calculation.
     */
    abstract class RebalanceStarRating {
        /**
         * The calculated beatmap.
         */
        map: Beatmap;
         ...
         */
        readonly objects: RebalanceDifficultyHitObject[];
        /**
         ...
         */
        protected calculateSkills(...skills: RebalanceSkill[]): void;
        /**
         * Calculates the total star rating of the beatmap and stores it in this instance.
         */
         ...
         * Creates skills to be calculated.
         */
        protected abstract createSkills(): RebalanceSkill[];
    }
