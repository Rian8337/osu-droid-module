...
import { RebalanceDifficultyHitObjectCreator } from "../preprocessing/RebalanceDifficultyHitObjectCreator";
import { RebalanceStrainSkill } from "./RebalanceStrainSkill";
 ...
 */
export abstract class RebalanceStarRating {
    /**
    ...
    generateDifficultyHitObjects(mode: modes): void {
        ...
        this.objects.push(
            ...new RebalanceDifficultyHitObjectCreator().generateDifficultyObjects(
                {
     ...
     */
    protected calculateSkills(...skills: RebalanceStrainSkill[]): void {
     ...
     */
    protected abstract createSkills(): RebalanceStrainSkill[];
