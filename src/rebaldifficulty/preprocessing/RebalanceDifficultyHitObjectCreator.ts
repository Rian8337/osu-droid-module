...
import { RebalanceDifficultyHitObject } from "./RebalanceDifficultyHitObject";
...
export class RebalanceDifficultyHitObjectCreator {
    ...
    generateDifficultyObjects(params: {
        ...
        const difficultyObjects: RebalanceDifficultyHitObject[] = [];

        for (let i = 0; i < params.objects.length; ++i) {
            const object: RebalanceDifficultyHitObject =
                new RebalanceDifficultyHitObject(params.objects[i]);
            ...
            const lastObject: RebalanceDifficultyHitObject =
                difficultyObjects[i - 1];
            const lastLastObject: RebalanceDifficultyHitObject =
