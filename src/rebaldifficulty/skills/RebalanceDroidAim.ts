...
export class RebalanceDroidAim extends RebalanceDroidSkill {
     ...
     */
    private aimStrainOf(current: RebalanceDifficultyHitObject): number {
        if (
        ...
        const last: RebalanceDifficultyHitObject = this.previous[0];
        const lastLast: RebalanceDifficultyHitObject = this.previous[1];
     ...
     */
    private movementStrainOf(current: RebalanceDifficultyHitObject): number {
