...
import { RebalanceDroidStarRating } from "./RebalanceDroidStarRating";
import { MapStats } from "../utils/MapStats";
import { RebalancePerformanceCalculator } from "./base/RebalancePerformanceCalculator";
...
export class RebalanceDroidPerformanceCalculator extends RebalancePerformanceCalculator {
    override stars: RebalanceDroidStarRating = new RebalanceDroidStarRating();
