    ...
    await testDiffCalc(
        "YOASOBI - Love Letter (ohm002) [Please accept my overflowing emotions.]",
        {
            noModDroidRating: {
                ...
                visual: 1.0121976016117962,
                total: 4.134114901402697,
            },
            noModPcRating: {
            ...
            clockRateDroidRating: {
                ...
                visual: 1.1410342650116896,
                total: 5.406086763798694,
            },
            clockRatePcRating: {
...
test("Test difficulty calculation sample beatmap 2", async () => {
    await testDiffCalc("Kenji Ninuma - DISCOPRINCE (peppy) [Normal]", {
        noModDroidRating: {
            ...
            visual: 1.9192547343917892,
            total: 4.945147643534112,
        },
        noModPcRating: {
        ...
        clockRateDroidRating: {
            ...
            visual: 1.0777178821349556,
            total: 3.811365775202142,
        },
        clockRatePcRating: {
    ...
    await testDiffCalc(
        "sphere - HIGH POWERED (TV Size) (Azunyan-) [POWER OVERLOAD EXPERT]",
        {
            noModDroidRating: {
                ...
                visual: 1.095929841462343,
                total: 5.966370466334077,
            },
            noModPcRating: {
            ...
            clockRateDroidRating: {
                ...
                visual: 1.6473309205446554,
                total: 8.7859879056322,
            },
            clockRatePcRating: {
...
test("Test difficulty calculation sample beatmap 4", async () => {
    await testDiffCalc("Ocelot - KAEDE (Hollow Wings) [EX EX]", {
        noModDroidRating: {
            ...
            visual: 0.9643013953038241,
            total: 4.667497862761793,
        },
        noModPcRating: {
        ...
        clockRateDroidRating: {
            ...
            visual: 2.223485182138708,
            total: 6.999044342555772,
        },
        clockRatePcRating: {
