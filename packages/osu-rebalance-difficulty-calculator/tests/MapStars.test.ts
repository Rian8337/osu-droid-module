    ...
    await testDiffCalc(
        "YOASOBI - Love Letter (ohm002) [Please accept my overflowing emotions.]",
        {
            noModDroidRating: {
                ...
                visual: 1.1215515729827308,
                total: 4.029551726380359,
            },
            noModPcRating: {
            ...
            clockRateDroidRating: {
                ...
                visual: 1.4406582932108043,
                total: 5.409038162855948,
            },
            clockRatePcRating: {
...
test("Test difficulty calculation sample beatmap 2", async () => {
    await testDiffCalc("Kenji Ninuma - DISCOPRINCE (peppy) [Normal]", {
        noModDroidRating: {
            ...
            visual: 0.9450788195819237,
            total: 3.045314931854283,
        },
        noModPcRating: {
        ...
        clockRateDroidRating: {
            ...
            visual: 1.0714572764133687,
            total: 3.5429619532666705,
        },
        clockRatePcRating: {
    ...
    await testDiffCalc(
        "sphere - HIGH POWERED (TV Size) (Azunyan-) [POWER OVERLOAD EXPERT]",
        {
            noModDroidRating: {
                ...
                visual: 1.3286653392205188,
                total: 5.698151395415102,
            },
            noModPcRating: {
            ...
            clockRateDroidRating: {
                ...
                visual: 1.848338561543391,
                total: 8.29090394324863,
            },
            clockRatePcRating: {
...
test("Test difficulty calculation sample beatmap 4", async () => {
    await testDiffCalc("Ocelot - KAEDE (Hollow Wings) [EX EX]", {
        noModDroidRating: {
            ...
            visual: 1.9369007477243032,
            total: 5.271751194705994,
        },
        noModPcRating: {
        ...
        clockRateDroidRating: {
            ...
            visual: 2.8745127572006552,
            total: 7.060771093643295,
        },
        clockRatePcRating: {
    ...
    await testDiffCalc(
        "m1dlet - Tell Me Why Speedcore Is So Awesome (None1637) [DROID Ultimate PP CS32 x2]",
        {
            noModDroidRating: {
                ...
                visual: 3.2518162329525326,
                total: 92.44616161461117,
            },
            noModPcRating: {
            ...
            clockRateDroidRating: {
                ...
                visual: 5.745408269059448,
                total: 116.43516907297443,
            },
            clockRatePcRating: {
