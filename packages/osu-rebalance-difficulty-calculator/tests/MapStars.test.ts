    ...
    await testDiffCalc(
        "sphere - HIGH POWERED (TV Size) (Azunyan-) [POWER OVERLOAD EXPERT]",
        {
            ...
            clockRateDroidRating: {
                ...
                visual: 1.0878439651633547,
                total: 7.785722651102326,
            },
            clockRatePcRating: {
