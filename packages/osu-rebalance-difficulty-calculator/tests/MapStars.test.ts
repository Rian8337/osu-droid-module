    ...
    await testDiffCalc(
        "m1dlet - Tell Me Why Speedcore Is So Awesome (None1637) [DROID Ultimate PP CS32 x2]",
        {
            noModDroidRating: {
                ...
                visual: 4.5491569495271165,
                total: 92.45043121822972,
            },
            noModPcRating: {
