    ...
    testDiffCalc(
        "YOASOBI - Love Letter (ohm002) [Please accept my overflowing emotions.]",
        {
            noMod: {
                ...
                reading: 0.04443103779583087,
                total: 3.5861472084331294,
            },
            doubleTime: {
                aim: 2.5070618779673466,
                tap: 2.22637269107595,
                rhythm: 0.7507595845390408,
                reading: 1.0328225068113965,
                total: 5.047564009551038,
            },
    ...
    testDiffCalc(
        "sphere - HIGH POWERED (TV Size) (Azunyan-) [POWER OVERLOAD EXPERT]",
        {
            noMod: {
                ...
                reading: 0.403806351279146,
                total: 5.707716679866984,
            },
            doubleTime: {
                aim: 2.917767207907698,
                tap: 4.412143589015001,
                rhythm: 1.1908604568024859,
                reading: 1.2182515730926957,
                total: 8.089255424897399,
            },
...
describe("Test difficulty calculation sample beatmap 4", () => {
    testDiffCalc("Ocelot - KAEDE (Hollow Wings) [EX EX]", {
        noMod: {
            ...
            reading: 0.17968585869751122,
            total: 4.5104816051944,
        },
        doubleTime: {
            aim: 3.3453830310417234,
            tap: 2.098550903093177,
            rhythm: 1.0791633372145433,
            reading: 1.8365442841976387,
            total: 6.2523490797659536,
        },
    ...
    testDiffCalc(
        "m1dlet - Tell Me Why Speedcore Is So Awesome (None1637) [DROID Ultimate PP CS32 x2]",
        {
            noMod: {
                ...
                reading: 5.227454157613026,
                total: 21.950422175040895,
            },
            doubleTime: {
                aim: 14.193717780959025,
                tap: 8.556679042177844,
                rhythm: 0.9560640405601507,
                reading: 8.817553488900899,
                total: 26.78149456810137,
            },
...
describe("Test difficulty calculation sample beatmap 7", () => {
    testDiffCalc("Camellia - crystallized (-ckopoctb-) [Emilia's C9H13NO3]", {
        noMod: {
            ...
            reading: 0.16922273166535937,
            total: 5.394422535825232,
        },
        doubleTime: {
            aim: 3.5392235398725327,
            tap: 3.9294747698179813,
            rhythm: 1.2120473532768323,
            reading: 2.2223726586307015,
            total: 8.088585653076047,
        },
