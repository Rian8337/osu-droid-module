    ...
    testDiffCalc(
        "YOASOBI - Love Letter (ohm002) [Please accept my overflowing emotions.]",
        {
            noMod: {
                ...
                reading: 0.7500779395524453,
                total: 3.840357717512081,
            },
            doubleTime: {
                aim: 3.4130382829133263,
                tap: 2.1566276461936593,
                rhythm: 0.9653275604053236,
                reading: 1.7838126334408704,
                total: 5.26545246014207,
            },
...
describe("Test difficulty calculation sample beatmap 2", () => {
    testDiffCalc("Kenji Ninuma - DISCOPRINCE (peppy) [Normal]", {
        noMod: {
            ...
            reading: 0.2842464804695949,
            total: 2.140983914763346,
        },
        doubleTime: {
            aim: 1.4068939518492614,
            tap: 1.3845870791416075,
            rhythm: 0.7601331678413251,
            reading: 0.4011007696067128,
            total: 2.8162088922452413,
        },
    ...
    testDiffCalc(
        "sphere - HIGH POWERED (TV Size) (Azunyan-) [POWER OVERLOAD EXPERT]",
        {
            noMod: {
                ...
                reading: 1.5843238150775523,
                total: 5.772740597391886,
            },
            doubleTime: {
                aim: 4.0162528796418675,
                tap: 4.243266798331955,
                rhythm: 1.358265932768112,
                reading: 2.9537909568916727,
                total: 7.854523714689176,
            },
...
describe("Test difficulty calculation sample beatmap 4", () => {
    testDiffCalc("Ocelot - KAEDE (Hollow Wings) [EX EX]", {
        noMod: {
            ...
            reading: 1.987325772528528,
            total: 4.6985926106452585,
        },
        doubleTime: {
            aim: 4.078958258899205,
            tap: 2.0374503948541545,
            rhythm: 0.9791548169336958,
            reading: 4.348437120912226,
            total: 6.581165062529668,
        },
    ...
    testDiffCalc(
        "m1dlet - Tell Me Why Speedcore Is So Awesome (None1637) [DROID Ultimate PP CS32 x2]",
        {
            noMod: {
                ...
                reading: 519.0589722451645,
                total: 356.0870414034074,
            },
            doubleTime: {
                aim: 1084.8669568112875,
                tap: 6.930544796727792,
                rhythm: 0.6154594006084403,
                reading: 925.8367647319343,
                total: 435.41219970337784,
            },
...
describe("Test difficulty calculation sample beatmap 7", () => {
    testDiffCalc("Camellia - crystallized (-ckopoctb-) [Emilia's C9H13NO3]", {
        noMod: {
            ...
            reading: 0.9999485602348157,
            total: 5.213359018806274,
        },
        doubleTime: {
            aim: 4.567100605731228,
            tap: 3.745672783616189,
            rhythm: 1.599946939466027,
            reading: 4.523780087927296,
            total: 7.908235487102161,
        },
